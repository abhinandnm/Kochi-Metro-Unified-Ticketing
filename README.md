...
>
>  The `product-made-in-competition` branch preserves the original prototype created during the two-hour sprint. No further updates are made to that branch; ongoing development happens on `main`.
